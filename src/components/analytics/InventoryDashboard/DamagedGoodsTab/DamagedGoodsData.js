...
export default function DamagedGoodsData(props) {
    ...
    return (
        ...
        <Typography>The Damaged Goods chart displays <span style={{color:"#1890ff", fontWeight:"bold"}}>a list of products that have been damaged or lost</span>, along with its corresponding quantity and cost of goods sold value, during the period below.</Typography>
